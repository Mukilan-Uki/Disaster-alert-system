    ...
    <div className="container">
      <div className="top-section row">
        <div className="hero-section col  text-light">
          <h1 className="hero-title">
            <i className="fa-solid fa-bell"></i> Sri Lanka Disaster Alert System
          </h1>
          <p className="hero-subtitle">
            Real-time alerts and preparedness information for natural disasters
            in Sri Lanka
          </p>
        </div>
        ...
        <div className="col">
          <h2 className=" text-light">
            <i className="fa-solid fa-location-dot"></i> Check Weather
          </h2>
          <form
            onSubmit={handleSearch}
            className="location-input-container form-floating"
          >
            <input
              type="text"
      ...
      <div className="cities-weather-section text-light">
        <h2 className="text-center">
          <i className="fa-solid fa-globe"></i> Weather Across Sri Lanka
        </h2>
      ...
      <div className="alerts-section my-5">
        <h2 className="text-center text-light">
          <i className="fa-solid fa-bell"></i> Active Alerts
        </h2>
            ...
            >
              ...
              <div className="alert-footer fs-4">
                <span className="alert-area">
                  <i className="fa-solid fa-location"></i> {alert.area}
                </span>
                <br />
                <span className="alert-time">
                  <i className="fa-solid fa-clock"></i> {alert.time}
                </span>
              </div>
            </div>
          ))}
      ...
      <div className="contacts-section my-5">
        <h2 className="text-center text-light">
          <i className="fa-solid fa-hand"></i> Emergency Contacts
        </h2>
        <div className="contacts-grid row my-4">
          {emergencyContacts.map((contact, index) => (
            <div key={index} className="contact-card text-center m-3 p-3 col">
              <div className="contact-name">{contact.name}</div>
              <div className="contact-number fw-bold fs-3">
                {contact.number}
              </div>
              <button className="contact-button btn btn-danger">
      ...
      <div className="actions-section d-flex justify-content-center">
        <div className="actions-buttons btn-group">
          <button className="action-button btn btn-outline-light">
            <i className="fa-solid fa-book"></i> View Preparedness Checklist
          </button>
          <button className="action-button btn btn-light">
            <i className="fa-solid fa-map"></i> Find Nearest Shelter
          </button>
          <button className="action-button btn btn-outline-light">
            <i className="fa-solid fa-tower-broadcast"></i> Subscribe to Alerts
          </button>
          <button className="action-button btn btn-light">
            <i className="fa-solid fa-chart-simple"></i> View Historical Data
          </button>
        </div>
      </div>
    </div>
