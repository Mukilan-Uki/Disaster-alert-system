...
function Home() {
  ...
  return (
    <div className="container">
      ...
      <div className='col'>
        <h2 className=' text-light'><i className="fa-solid fa-location-dot"></i> Check Weather</h2>
      ...
      <div className="alerts-section my-5">
        <h2 className='text-center text-light'><i className="fa-solid fa-bell"></i> Active Alerts</h2>
            ...
            {mockAlerts.map(alert => (
              ...
              >
                ...
                <div className="alert-footer fs-4">
                  ...
                  <span className="alert-time"><i className="fa-solid fa-clock"></i> {alert.time}</span>
                </div>
              </div>
            ))}
          </div>
      ...
      <div className="contacts-section my-5">
        <h2 className='text-center text-light'><i className="fa-solid fa-hand"></i> Emergency Contacts</h2>
        <div className="contacts-grid row my-4">
          {emergencyContacts.map((contact, index) => (
            <div key={index} className="contact-card text-center m-3 p-3 col">
              ...
              <button className="contact-button btn btn-danger"><i className="fa-solid fa-phone"></i> Call Now</button>
            </div>
          ))}
        </div>
      </div>
      
      <h2 className='text-center my-4 text-light'><i className="fa-solid fa-bolt"></i> Quick Actions</h2>
